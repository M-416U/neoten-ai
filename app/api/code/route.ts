    ...
    const modifedMessages = [
      {
        role: "user",
        content:
          "you name is now is neoten if i asked you about your name,and You are a code generator. You must answer only in markdown code snippets. Use code comments for explanations.",
      },
      ...messages,
    ];
